...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.hanxing.boot";
    private static final String ARTIFACT_ID = "kxcharge";
    private static final String PACKAGE_NAME = "com.hanxing.kxcharge";
    private static final String TITLE = "航兴充电运营管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.hanxing.boot";
        String artifactIdNew = "kxcharge";
        String packageNameNew = "com.hanxing.kxcharge";
        String titleNew = "航兴充电运营管理系统";
        String projectBaseDirNew = "E:\\cloudSpace\\kxcharge"; // 一键改名后，“新”项目所在的目录
