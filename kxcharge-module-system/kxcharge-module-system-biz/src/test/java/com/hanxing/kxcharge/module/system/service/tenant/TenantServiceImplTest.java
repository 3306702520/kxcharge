package com.hanxing.kxcharge.module.system.service.tenant;

import com.hanxing.kxcharge.framework.common.enums.CommonStatusEnum;
import com.hanxing.kxcharge.framework.common.pojo.PageResult;
import com.hanxing.kxcharge.framework.tenant.config.TenantProperties;
...
import com.hanxing.kxcharge.module.system.dal.dataobject.permission.RoleDO;
import com.hanxing.kxcharge.module.system.dal.dataobject.tenant.TenantDO;
import com.hanxing.kxcharge.module.system.dal.dataobject.tenant.TenantPackageDO;
import com.hanxing.kxcharge.module.system.dal.mysql.tenant.TenantMapper;
import com.hanxing.kxcharge.module.system.enums.permission.RoleCodeEnum;
import com.hanxing.kxcharge.module.system.enums.permission.RoleTypeEnum;
import com.hanxing.kxcharge.module.system.service.permission.MenuService;
...
import com.hanxing.kxcharge.module.system.service.tenant.handler.TenantInfoHandler;
import com.hanxing.kxcharge.module.system.service.tenant.handler.TenantMenuHandler;
import com.hanxing.kxcharge.module.system.service.user.AdminUserService;
...
import static com.hanxing.kxcharge.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("航兴", user.getNickname());
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("航兴"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("航兴");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
