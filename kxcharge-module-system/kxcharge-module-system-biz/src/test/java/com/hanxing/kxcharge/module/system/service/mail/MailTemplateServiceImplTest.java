package com.hanxing.kxcharge.module.system.service.mail;
...
import com.hanxing.kxcharge.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
import com.hanxing.kxcharge.module.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
import com.hanxing.kxcharge.module.system.dal.dataobject.mail.MailTemplateDO;
import com.hanxing.kxcharge.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static com.hanxing.kxcharge.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("航兴")));
        // 测试 code 不匹配
