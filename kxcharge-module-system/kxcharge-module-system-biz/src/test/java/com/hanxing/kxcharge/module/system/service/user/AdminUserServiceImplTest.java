package com.hanxing.kxcharge.module.system.service.user;
...
import com.hanxing.kxcharge.framework.common.util.collection.ArrayUtils;
...
import com.hanxing.kxcharge.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.hanxing.kxcharge.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.hanxing.kxcharge.module.system.controller.admin.user.vo.user.*;
...
import com.hanxing.kxcharge.module.system.dal.dataobject.dept.UserPostDO;
...
import com.hanxing.kxcharge.module.system.dal.mysql.dept.UserPostMapper;
import com.hanxing.kxcharge.module.system.dal.mysql.user.AdminUserMapper;
import com.hanxing.kxcharge.module.system.enums.common.SexEnum;
import com.hanxing.kxcharge.module.system.service.dept.DeptService;
import com.hanxing.kxcharge.module.system.service.dept.PostService;
import com.hanxing.kxcharge.module.system.service.permission.PermissionService;
...
import static com.hanxing.kxcharge.framework.common.util.collection.SetUtils.asSet;
...
import static com.hanxing.kxcharge.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn(success("kxchargeyuanma"));
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("kxchargeyuanma");
        ...
        assertEquals("kxchargeyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("kxchargeyuanma"))).thenReturn("java");
