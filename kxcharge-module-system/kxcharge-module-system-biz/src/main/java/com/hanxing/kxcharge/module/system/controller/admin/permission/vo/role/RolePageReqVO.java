package com.hanxing.kxcharge.module.system.controller.admin.permission.vo.role;
...
public class RolePageReqVO extends PageParam {
    ...
    @Schema(description = "角色名称，模糊匹配", example = "航兴")
    private String name;

    @Schema(description = "角色标识，模糊匹配", example = "kxcharge")
    private String code;
