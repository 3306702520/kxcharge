package com.hanxing.kxcharge.module.system.controller.admin.dict.vo.type;
...
public class DictTypeSimpleRespVO {
    ...
    @Schema(description = "字典类型名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "航兴")
    private String name;
