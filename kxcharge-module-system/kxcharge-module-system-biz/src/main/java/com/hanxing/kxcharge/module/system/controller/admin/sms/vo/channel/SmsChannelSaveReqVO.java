package com.hanxing.kxcharge.module.system.controller.admin.sms.vo.channel;
...
public class SmsChannelSaveReqVO {
    ...
    @Schema(description = "短信签名", requiredMode = Schema.RequiredMode.REQUIRED, example = "航兴新能源")
    ...
    @Schema(description = "短信 API 的账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "kxcharge")
    ...
    @Schema(description = "短信发送回调 URL", example = "https://a.kxmall.vip")
