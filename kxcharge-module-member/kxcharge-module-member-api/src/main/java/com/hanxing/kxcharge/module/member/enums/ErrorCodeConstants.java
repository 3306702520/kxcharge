...
public interface ErrorCodeConstants {
    ...
    // ========== 用户车牌信息  ==========
    ErrorCode PLATE_NOT_EXISTS = new ErrorCode(1_004_015_000, "用户车牌信息不存在");

    // ========== 页面规则配置  ==========
    ErrorCode PAGE_RULE_NOT_EXISTS = new ErrorCode(1_004_016_000, "页面规则配置不存在");

    // ========== 客户意见反馈 ==========
    ErrorCode FEEDBACK_NOT_EXISTS = new ErrorCode(1_004_017_000, "客户意见反馈不存在");
}
