package com.hanxing.kxcharge.module.member.api.address.dto;
...
public class MemberAddressRespDTO {
    ...
    @Schema(description = "收件人名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "航兴")
    private String name;
    ...
    @Schema(description = "收件详细地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "航兴新能源 88 小区 106 号")
