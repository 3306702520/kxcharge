...
export default class SheepPay {
  constructor(payment, orderType, id, connectorCode) {
  ...
  payResult(resultType) {
    goPayResult(this.id, this.orderType, resultType, this.connectorCode);
  }
...
// 支付结果跳转,success:成功，fail:失败
export function goPayResult(id, orderType, resultType, connectorCode) {
