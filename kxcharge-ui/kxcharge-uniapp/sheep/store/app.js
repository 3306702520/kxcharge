...
const app = defineStore({
  ...
  actions: {
    ...
    async init(templateId = null) {
      ...
      // TODO 未来支持管理后台可配；对应 https://api.shopro.sheepjs.com/shop/api/init
      if (true) {
        this.info = {
          name: '航兴充电桩',
          logo: 'https://kxcharge.oss-cn-beijing.aliyuncs.com/logo/logo.png',
          version: '2.3.0',
          copyright: '商业版本',
          copytime: 'Copyright© 2023-2025',
        ...
        this.platform = {
          share: {
            methods: ['poster', 'link'],
            linkAddress: 'http://127.0.0.1:3000', // TODO 可以考虑改到 .env 那
            posterInfo: {
