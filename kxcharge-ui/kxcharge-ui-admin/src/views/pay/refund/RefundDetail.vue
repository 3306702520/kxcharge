<template>
  <Dialog v-model="dialogVisible" title="详情" width="700px">
    ...
    <el-descriptions :column="2" label-class-name="desc-label" direction="vertical" border>
      <el-descriptions-item label="支付通道异步回调内容" :width="100" style="word-break: break-all;">
