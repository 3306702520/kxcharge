    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['member:carousel:create']"
        >
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column
        ...
        width="180px"
      />
      <el-table-column label="轮播标题" align="center" prop="name" />
      <el-table-column label="轮播图片" align="center" prop="url" />
      <el-table-column label="跳转类型" align="center" prop="jumpType">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.JUMP_TYPE" :value="scope.row.jumpType" />
        </template>
      </el-table-column>
      <el-table-column label="跳转路径" align="center" prop="page" />
      ...
      <el-table-column label="操作" align="center" min-width="120px">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['member:carousel:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['member:carousel:delete']"
          >
            删除
          </el-button>
        </template>
