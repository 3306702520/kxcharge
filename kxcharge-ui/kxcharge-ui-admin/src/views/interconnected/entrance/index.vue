    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['interconnected:entrance:create']"
        >
        ...
        <!-- <el-button
          ...
          v-hasPermi="['interconnected:entrance:export']"
        >
      ...
      <el-table-column label="操作" align="center" width="180">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['interconnected:entrance:update']"
          >
            编辑
          </el-button>
          <el-popconfirm
          ...
          <el-button
            ...
            v-hasPermi="['interconnected:entrance:delete']"
          >
            删除
          </el-button>
