  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      <el-form-item label="短信签名" prop="signature">
        <el-input v-model="formData.signature" v-no-space placeholder="请输入短信签名" />
      </el-form-item>
      ...
      <el-form-item label="短信 API 的账号" prop="apiKey">
        <el-input v-model="formData.apiKey" v-no-space placeholder="请输入短信 API 的账号" />
      </el-form-item>
...
const formRules = reactive({
  signature: [{ required: true, message: '内容不能为空', validator: contentValidator, trigger: 'blur' }],
  code: [{ required: true, message: '渠道编码不能为空', trigger: 'blur' }],
  status: [{ required: true, message: '启用状态不能为空', trigger: 'blur' }],
  apiKey: [{ required: true, message: '内容不能为空', validator: contentValidator, trigger: 'blur' }]
})
