    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['interflow:certificate:create']"
        >
        ...
        <!-- <el-button
          ...
          v-hasPermi="['interflow:certificate:export']"
        >
      ...
      <el-table-column label="操作" align="center" width="180">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['interflow:certificate:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['interflow:certificate:delete']"
          >
            删除
          </el-button>
        </template>
...
import * as CertificateApi from '@/api/interflow/certificate'
