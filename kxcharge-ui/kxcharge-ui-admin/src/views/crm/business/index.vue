  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button type="primary" @click="openForm('create')" v-hasPermi="['crm:operations:create']">
        ...
        <el-button
          ...
          v-hasPermi="['crm:operations:export']"
        >
      ...
      <el-table-column label="操作" align="center" fixed="right" width="130px">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['crm:operations:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['crm:operations:delete']"
          >
            删除
          </el-button>
        </template>
