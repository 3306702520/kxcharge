...
const beforeUpload: UploadProps['beforeUpload'] = (rawFile) => {
  ...
  if (pattern.test(rawFile.name)) message.notifyWarning(`图片名称不能包含中文`)
  return imgType.includes(rawFile.type as FileTypes) && imgSize && !pattern.test(rawFile.name)
}
