...
@Data
public class NotificationEquipChargeStatusReqDto implements Serializable {

    public static final String QUEUE = "CHARGE_SERVER_NOTIFICATION_EQUIPCHARGE_STATUS";
