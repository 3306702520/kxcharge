...
@Schema(description = "管理后台 - 站点信息更新 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class StationUpdateReqVO extends StationBaseVO {

    @Schema(description = "主键", requiredMode = Schema.RequiredMode.REQUIRED, example = "20157")
    ...
    @NotNull(message = "电站位置（地上、地下）不能为空")
