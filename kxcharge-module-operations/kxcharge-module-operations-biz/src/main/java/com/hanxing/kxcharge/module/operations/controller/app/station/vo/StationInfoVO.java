...
public class StationInfoVO {
     ...
     * 交流电空闲枪数量
     */
    private Integer leisureConnectorNumber;

    /**
     * 直流枪数量
     */
    private Integer slowConnectorNumber;

    /**
     * 直流空闲枪数量
     */
    private Integer slowLeisureConnectorNumber;
     ...
     * 计费模型
     */
    private CostTemplateRespVO costTemplateRespVO;

    /**
     * 电枪列表
     */
    private List<EquipmentConnectorInfoVO> equipmentConnectorInfoVOS;
}
