...
@Schema(description = "管理后台 - 设备型号管理更新 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class EquipmentModelUpdateReqVO extends EquipmentModelBaseVO {

    @Schema(description = "主键", requiredMode = Schema.RequiredMode.REQUIRED, example = "6916")
