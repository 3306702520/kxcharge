package com.hanxing.kxcharge.module.infra.framework.file.core.s3;
...
public class S3FileClientTest {
    ...
    public void testMinIO() throws Exception {
        ...
        config.setBucket("kxchargeyuanma");
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setDomain("http://test.kxcharge.iocoder.cn"); // 如果有自定义域名，则可以设置。http://static.kxcharge.iocoder.cn
        // 默认上海的 endpoint
