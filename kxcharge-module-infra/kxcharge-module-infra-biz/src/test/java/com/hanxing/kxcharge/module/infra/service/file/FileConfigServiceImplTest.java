package com.hanxing.kxcharge.module.infra.service.file;
...
import com.hanxing.kxcharge.module.infra.dal.mysql.file.FileConfigMapper;
import com.hanxing.kxcharge.module.infra.framework.file.core.client.FileClient;
...
import com.hanxing.kxcharge.module.infra.framework.file.core.client.local.LocalFileClient;
import com.hanxing.kxcharge.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import com.hanxing.kxcharge.module.infra.framework.file.core.enums.FileStorageEnum;
import lombok.Data;
...
import static com.hanxing.kxcharge.framework.test.core.util.RandomUtils.randomLongId;
import static com.hanxing.kxcharge.framework.test.core.util.RandomUtils.randomPojo;
import static com.hanxing.kxcharge.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.hanxing.kxcharge.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testUpdateFileConfig_success() {
        ...
        FileConfigSaveReqVO reqVO = randomPojo(FileConfigSaveReqVO.class, o -> {
            ...
            Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/yunai2")
                    .put("domain", "https://cdzdoc.kxmall.vip").build();
            o.setConfig(config);
        });
        ...
        assertEquals("https://cdzdoc.kxmall.vip", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // 验证 cache
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("航兴新能源")
