package com.hanxing.kxcharge.module.infra.controller.admin.logger.vo.apierrorlog;
...
public class ApiErrorLogRespVO {
    ...
    @DictFormat(com.hanxing.kxcharge.module.system.enums.DictTypeConstants.USER_TYPE)
