package com.hanxing.kxcharge.module.infra.service.codegen.inner;
...
import com.hanxing.kxcharge.framework.apilog.core.enums.OperateTypeEnum;
...
import com.hanxing.kxcharge.framework.common.util.date.LocalDateTimeUtils;
...
import com.hanxing.kxcharge.framework.common.util.string.StrUtils;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "kxcharge-module-${table.moduleName}/" + // 顶级模块
                "kxcharge-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "kxcharge-module-${table.moduleName}/" + // 顶级模块
                "kxcharge-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "kxcharge-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "kxcharge-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
