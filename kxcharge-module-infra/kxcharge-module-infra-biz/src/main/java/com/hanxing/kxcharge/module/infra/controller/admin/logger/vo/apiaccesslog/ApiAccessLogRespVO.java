package com.hanxing.kxcharge.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(com.hanxing.kxcharge.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
    ...
    @Schema(description = "结果提示", example = "航兴新能源，牛逼！")
    @ExcelProperty("结果提示")
