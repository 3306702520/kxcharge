...
import com.hanxing.kxcharge.framework.tracer.core.aop.BizTraceAspect;
import com.hanxing.kxcharge.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "kxcharge.tracer", value = "enable", matchIfMissing = true)
public class KxchargeTracerAutoConfiguration {
