package com.hanxing.kxcharge.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${kxcharge.websocket.sender-rocketmq.topic}",
        consumerGroup = "${kxcharge.websocket.sender-rocketmq.consumer-group}",
